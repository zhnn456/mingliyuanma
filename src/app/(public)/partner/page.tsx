...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
  title: '创业合作 - 低成本创业·快速部署·即时赚钱',
  description:
    `${brandName}创业合作计划：源码部署一次买断独立运营、无限 SaaS 开户、单独 SaaS 开户，0 元开户、99 元/月起，客户充值即分润，最高 60% 分润比例。八字、紫微斗数、奇门遁甲、梅花易数完整平台，一键部署当天上线。`,
  keywords: [
  ...
  openGraph: {
    title: `创业合作 - ${brandName}：低成本创业 · 快速部署 · 即时赚钱`,
    description:
