...
export const metadata: Metadata = {
  title: '服务条款 - 命理网',
  description: '命理网服务条款，了解使用我们命理测算服务的相关规定和条件。',
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-amber-50 border-2 border-amber-200 rounded-2xl p-6 mb-6">
          ...
          <p className="text-sm text-amber-800 leading-relaxed">
            命理网提供的所有命理测算服务（包括但不限于八字排盘、紫微斗数、奇门遁甲、梅花易数等）仅供娱乐参考。
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <div className="space-y-4 text-sm text-gray-600">
            ...
            <div>
              ...
              <ul className="pl-5 list-disc space-y-1">
                <li>我们保留随时修改、中断或终止部分或全部服务的权利</li>
                <li>服务变更前，我们将在网站上发布公告</li>
                <li>因服务变更导致的任何损失，我们不承担责任</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <div className="space-y-3 text-sm text-gray-600">
            ...
            <p>以上内容的知识产权均归命理网所有，受《中华人民共和国著作权法》及相关法律法规保护。</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <div className="space-y-3 text-sm text-gray-600">
            ...
            <ul className="pl-5 list-disc space-y-2">
              ...
              <li><strong>间接损失：</strong>任何间接损失，包括但不限于利润损失、业务中断等。</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
          ...
          <p className="text-sm text-gray-600">
            我们可能会不定期更新本服务条款。当条款发生变更时，我们会在网站上发布更新通知。
            继续使用本网站服务即视为您同意更新后的条款。建议您定期查看本条款。
          </p>
        </div>
